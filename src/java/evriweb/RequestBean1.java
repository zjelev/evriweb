...
public class RequestBean1 extends AbstractRequestBean {
    ...
    private Integer inNom;

    /**
     * Getter for property foodId.
     * @return Value of property foodId.
     */
    public Integer getInNom() {
        return this.inNom;
    }

    /**
     * Setter for property foodId.
     * @param foodId New value of property foodId.
     */
    public void setInNom(Object inNom) {
        this.inNom = ((Integer)inNom).intValue();
    }
